...
USER_NAME=$TEN_1_NAME
USER_PASS=$TEN_1_NAME
ROLE_NAME=$TEN_1_ROLE_NAME
TENANT_UUID=$(init_tenant $TENANT_NAME $USER_NAME $USER_PASS $ROLE_NAME)
...
USER_NAME=$TEN_2_NAME
USER_PASS=$TEN_2_NAME
ROLE_NAME=$TEN_2_ROLE_NAME
TENANT_UUID=$(init_tenant $TENANT_NAME $USER_NAME $USER_PASS $ROLE_NAME)
